...
This is my website forked from [felipecordero](https://github.com/felipecordero/felipecordero.github.io) and built with Hugo, a fast and modern static site generator. The site features a clean, responsive design powered by Tailwind CSS and uses felipecordero's theme, CareerCanvas, with some modifications to suit my own needs.
...
```bash
git clone --recurse-submodules https://github.com/paddy-w/jennifer-site
cd jennifer-site
```
